...
import LandingScreen from "./1_LandingScreen";
import AmountScreen from "./2_AmountScreen";
import PaymentScreen from "./3_PaymentScreen";
import IconButton from "@mui/material/IconButton";
import Logo from "../assets/gift-logo.png";

// Steps in the RVNU payment flow
const steps = ["LandingScreen", "AmountScreen", "PaymentScreen"];
...
export default function Pay() {
  ...
  const getStepContent = (step) => {
    switch (step) {
      ...
      case 1:
        return (
          <AmountScreen activeStep={activeStep} setActiveStep={setActiveStep} />
        );
      case 2:
        return (
          <PaymentScreen
